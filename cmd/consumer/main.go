...
kafka-consumer v%s
	...
	kafka-consumer -username=my-username -password=my-password -broker=my-broker -topic=my-topic -group=my-group
...
func main() {
	...
	group := flag.String("group", "", "Kafka group")
	...
	if *username == "" || *password == "" || *broker == "" || *topic == "" || *group == "" {
		flag.Usage()
		return
	}
